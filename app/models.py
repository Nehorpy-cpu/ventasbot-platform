...
class WhatsappIntegration(Base):
    ...
    display_phone: Mapped[str] = mapped_column(String(40), default="")
    access_token_env: Mapped[str] = mapped_column(String(120), default="")
    graph_version: Mapped[str] = mapped_column(String(20), default="v21.0")
...
class Conversation(Base):
    ...
    __table_args__ = (UniqueConstraint("tenant_id", "customer_id", name="uq_conversation_tenant_customer"),)

    id: Mapped[str] = mapped_column(String(32), primary_key=True, default=lambda: new_id("cnv"))
    tenant_id: Mapped[str] = mapped_column(ForeignKey("tenants.id"), index=True)
    customer_id: Mapped[str] = mapped_column(ForeignKey("customers.id"), index=True)
    status: Mapped[ConversationStatus] = mapped_column(Enum(ConversationStatus), default=ConversationStatus.BOT)
    assigned_user_id: Mapped[str | None] = mapped_column(ForeignKey("users.id"), nullable=True)
    active_order_id: Mapped[str | None] = mapped_column(ForeignKey("orders.id"), nullable=True, index=True)
    bot_state: Mapped[str] = mapped_column(String(80), default="START")
    bot_context: Mapped[str] = mapped_column(Text, default="")
...
class Payment(Base):
    ...
    __table_args__ = (UniqueConstraint("tenant_id", "idempotency_key", name="uq_payment_tenant_idempotency"),)
...
class PaymentMethodConfig(Base):
    ...
    id: Mapped[str] = mapped_column(String(32), primary_key=True, default=lambda: new_id("pmc"))
    tenant_id: Mapped[str] = mapped_column(ForeignKey("tenants.id"), index=True)
    ...
    public_key_env: Mapped[str] = mapped_column(String(120), default="")
    private_key_env: Mapped[str] = mapped_column(String(120), default="")
    commerce_code: Mapped[str] = mapped_column(String(40), default="")
...
class Delivery(Base):
    ...
    tracking_expires_at: Mapped[datetime] = mapped_column(
